...
class AnalisadorLexico:
    ...
    def tokenize_code(self, codigo: str):
        tokens = []
        linhas = codigo.split("\n")
        for contador_linhas, linha in enumerate(linhas, start=1):
            ...
            while len(lista_simbolos_linha) > 0:
                for simbolo in lista_simbolos_linha:
                    ...
                    if simbolo in ESTADOS[estado_atual]:
                        estado_atual = ESTADOS[estado_atual][simbolo]
                    elif simbolo.isalpha() and "letra" in ESTADOS[estado_atual]:
                        estado_atual = ESTADOS[estado_atual]["letra"]
                    elif simbolo.isdigit() and "numero" in ESTADOS[estado_atual]:
                        estado_atual = ESTADOS[estado_atual]["numero"]
                    else:
...
if __name__ == "__main__":
    print("-- init analisador lexico --")
    analisador_lexico = AnalisadorLexico
    analisador_lexico.tokenize_code()
